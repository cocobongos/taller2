...
public class TransicionFigure extends Figura<Transicion> {
	private PolygonShape rombo;

	public TransicionFigure(Transicion transicion) {
		super(transicion);
		this.setRepresentacion(EstilosFiguras.get(Transicion.class,
	 ...
	 * @param label
	 */
	public void conectarEntidad(Figura<Estado> figura, String label) {
