...
public class ModeloDERParserXml extends ModeloParserXml {

	public ModeloDERParserXml(Proyecto proyecto, String path) throws Exception {
		super(proyecto,path);
		
	}

	public ModeloDERParserXml(Proyecto proyecto) throws Exception {
		super(proyecto);
	}
